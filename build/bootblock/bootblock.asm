...
outb(ushort port, uchar data)
{
  __asm__ volatile("out %0,%1" : : "a" (data), "d" (port));
    ...
    7cab:	ba f4 01 00 00       	mov    $0x1f4,%edx
    7cb0:	c1 e8 08             	shr    $0x8,%eax
    7cb3:	ee                   	out    %al,(%dx)
    outb(0x1F5, offset >> 16);
    7cb4:	89 c8                	mov    %ecx,%eax
    7cb6:	ba f5 01 00 00       	mov    $0x1f5,%edx
...
void readseg(uchar* pa, uint count, uint offset) {
    ...
    pa -= offset % SECTSIZE;
    7d00:	89 d8                	mov    %ebx,%eax

    // Translate from bytes to sectors; kernel starts at sector 1.
    offset = (offset / SECTSIZE) + 1;
    7d02:	c1 eb 09             	shr    $0x9,%ebx
    pa -= offset % SECTSIZE;
    7d05:	25 ff 01 00 00       	and    $0x1ff,%eax
    epa = pa + count;
    7d0a:	01 fe                	add    %edi,%esi
    offset = (offset / SECTSIZE) + 1;
    7d0c:	43                   	inc    %ebx
    pa -= offset % SECTSIZE;
    7d0d:	29 c7                	sub    %eax,%edi
    ...
    7d16:	43                   	inc    %ebx
    7d17:	57                   	push   %edi
    7d18:	81 c7 00 02 00 00    	add    $0x200,%edi
    7d1e:	e8 69 ff ff ff       	call   7c8c <readsect>
